...
description: With the feature in place, B2B customers can log in to Spryker shop using a token. In the document, you can find a description of the token structure.
